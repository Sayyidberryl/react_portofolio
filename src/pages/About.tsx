...
const About = () => {
  const stats = [
    { label: "Experience", value: "1+ Year", icon: <CodeBracketIcon className="w-5 h-5" />, gradient: "from-white/10 to-transparent", border: "border-white/20" },
    { label: "Projects", value: "10+", icon: <RocketLaunchIcon className="w-5 h-5" />, gradient: "from-white/10 to-transparent", border: "border-white/20" },
    { label: "Certificate", value: "20+", icon: <SparklesIcon className="w-5 h-5" />, gradient: "from-white/10 to-transparent", border: "border-white/20" },
  ];
    ...
    <div className="text-white max-w-7xl mx-auto py-12 px-4 selection:bg-white/30">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 mb-16">
        ...
        <div className="lg:col-span-4 flex flex-col gap-5">
          {/* Profile Card */}
          <div className="group relative overflow-hidden bg-gradient-to-br from-white/[0.08] to-transparent backdrop-blur-md border border-white/10 rounded-3xl p-6 transition-all duration-500 hover:border-white/40">
            <div className="relative z-10">
              <div className="relative w-full aspect-square mb-6 group-hover:scale-[1.02] transition-transform duration-700">
                <img 
                  src={photoProfile} 
                  alt="Profile" 
                  className="w-full h-full object-cover rounded-2xl grayscale hover:grayscale-0 transition-all duration-700 ring-1 ring-white/10 shadow-2xl hover:shadow-[0_0_40px_rgba(168,85,247,0.5)]" 
                />
                <div className="absolute -bottom-2 -right-2 px-3 py-1 bg-white text-black text-[10px] font-black uppercase rounded-lg shadow-lg">
                  Available
                </div>
              </div>
              <div className="space-y-1">
                <h3 className="text-2xl font-bold tracking-tight">Sayyid Berryl Musthofa</h3>
                <p className="text-gray-300 font-medium text-sm">Backend Engineer</p>
            ...
            <div className="absolute -top-24 -right-24 w-48 h-48 bg-white/5 blur-[60px] rounded-full group-hover:bg-white/10 transition-colors"></div>
          </div>

          {/* Socials & Contact Card */}
          <div className="bg-white/[0.04] border border-white/10 rounded-3xl p-5 flex items-center justify-between group hover:border-white/40 transition-all">
             ...
             <div className="flex gap-2">
                <a 
                  ...
                  className="p-3 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 hover:border-white/40 transition-all text-gray-400 hover:text-white"
                >
        ...
        <div className="lg:col-span-8 flex flex-col gap-5">
          <div className="bg-[#050118] border border-white/10 rounded-3xl overflow-hidden shadow-2xl flex flex-col h-full group hover:border-white/30 hover:shadow-[0_0_40px_-10px_rgba(168,85,247,0.4)] transition-all duration-500">
            {/* Terminal Top Bar */}
            <div className="bg-white/5 px-4 py-3 flex items-center justify-between border-b border-white/5">
              <div className="flex gap-2">
                <div className="w-3 h-3 rounded-full bg-red-500 hover:bg-red-400 transition-colors cursor-pointer border border-red-600"></div>
                <div className="w-3 h-3 rounded-full bg-yellow-400 hover:bg-yellow-300 transition-colors cursor-pointer border border-yellow-500"></div>
                <div className="w-3 h-3 rounded-full bg-green-500 hover:bg-green-400 transition-colors cursor-pointer border border-green-600"></div>
              </div>
            ...
            {/* Terminal Body */}
            <div className="p-8 font-mono text-sm space-y-6 flex-1 bg-gradient-to-b from-transparent to-white/[0.02]">
              <div className="space-y-1">
                ...
                <p className="text-gray-300 leading-relaxed text-base">
                  ...
                  A passionate Backend Developer based in <span className="text-green-400">Bogor, Indonesia</span>. 
              ...
              <div className="space-y-1">
                 <div className="flex items-center gap-2 text-gray-400 opacity-60">
                    <span className="text-green-400">$</span> <span className="text-blue-400">specialization</span> <span className="text-yellow-400">--list</span>
                 </div>
                 <p className="text-gray-300 leading-relaxed text-base">
                   I specialize in building <span className="text-purple-400 font-semibold">robust and scalable systems</span> using 
                   <span className="text-purple-400 font-semibold"> Laravel, Spring Boot, </span> and 
                   <span className="text-purple-400 font-semibold"> Python (FastAPI)</span>. 
              ...
              <div className="space-y-1">
                 <div className="flex items-center gap-2 text-gray-400 opacity-60">
                    <span className="text-green-400">$</span> <span className="text-blue-400">cat</span> <span className="text-yellow-400">philosophy.txt</span>
                 </div>
                 <p className="text-gray-300 leading-relaxed text-base">
                   <span className="text-green-400">"Clean code isn't just a goal; it's the foundation of reliability."</span> 
            ...
            <div className="grid grid-cols-3 divide-x divide-white/5 bg-white/5 py-4">
              {stats.map((stat, idx) => (
                <div key={idx} className="text-center group/stat px-2">
                   <div className="text-lg font-black text-white group-hover/stat:text-white transition-colors uppercase tracking-widest">{stat.value}</div>
      ...
      <div className="mb-16">
         <div className="flex items-center gap-4 mb-10">
            <h3 className="text-2xl font-black border-l-4 border-white/50 pl-6 tracking-tight">System Arsenal</h3>
            <div className="flex-1 h-[2px] bg-gradient-to-r from-white/20 via-white/5 to-transparent"></div>
         </div>
         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {skills.map((s, i) => (
              <div key={i} className="group relative p-8 bg-white/[0.03] border border-white/10 rounded-[2rem] hover:bg-white/[0.06] hover:border-white/40 transition-all duration-500 flex flex-col items-center text-center overflow-hidden">
                 {/* Decorative background glow */}
                 <div className="absolute -top-10 -right-10 w-24 h-24 bg-white/5 blur-3xl group-hover:bg-white/10 transition-colors"></div>
                 
                 <div className="mb-6 relative transition-transform duration-500 group-hover:scale-110 group-hover:rotate-3">
                    <div className="p-5 bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 rounded-2xl shadow-xl group-hover:shadow-[0_0_30px_-5px_rgba(168,85,247,0.4)] text-gray-200">
                        {/* Enlarged Icon */}
                 ...
                 {/* Bottom accent light */}
                 <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1/2 h-[2px] bg-gradient-to-r from-transparent via-white/0 to-transparent group-hover:via-white/30 transition-all duration-700"></div>
              </div>
            ))}
         </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
         <div className="md:col-span-2 flex items-center gap-4 mb-8">
            <h3 className="text-2xl font-black border-l-4 border-white/50 pl-6 tracking-tight text-white">Career History</h3>
            <div className="flex-1 h-[2px] bg-gradient-to-r from-white/20 via-white/5 to-transparent"></div>
         </div>
         {experiments.map((exp, idx) => (
           <div key={idx} className="group relative bg-white/[0.03] border border-white/10 p-10 rounded-[2rem] hover:bg-white/[0.06] hover:border-white/30 transition-all duration-500 overflow-hidden">
              {/* Decorative background glow */}
              <div className="absolute -top-12 -left-12 w-32 h-32 bg-white/5 blur-3xl group-hover:bg-white/10 transition-colors"></div>
              
              <div className="relative z-10">
                <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-6">
                   <div>
                      <h4 className="text-2xl font-bold text-white group-hover:text-white transition-colors mb-1 tracking-tight">{exp.role}</h4>
                      <div className="flex items-center gap-2">
                         <span className="text-sm text-gray-200 font-bold uppercase tracking-wider">{exp.company}</span>
                      </div>
                   </div>
                ...
                <div className="flex flex-wrap gap-2.5">
                   {exp.tech.map(t => (
                     <span key={t} className="text-[11px] font-black text-gray-400 bg-white/5 px-3 py-1.5 rounded-lg border border-white/10 group-hover:border-white/30 group-hover:text-white transition-all uppercase tracking-tighter">
                        {t}
                     </span>
                   ))}
                </div>
